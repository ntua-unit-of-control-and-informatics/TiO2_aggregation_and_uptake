simulation_func <- function(sedimentation, score, N_iter){
  ...
  Size_estimation <- function(age, temperature, food="high"){
  ...
  obj_func <- function(x, score, sedimentation, C_water_0, nm_types, V_water, ksed_predicted){
  ...
  plot_func <- function(optimization, sedimentation, C_water_0, nm_types, V_water, ksed_predicted){
  ...
  x0 <- c(rep(1,5), rep(0.01, 5), rep(0.2,5),10)
  ...
  optimization <- nloptr::nloptr(x0 = x0,
                                 eval_f = obj_func,
                                 lb	= c(rep(0,10), c( 0.165, 0.148,0.143,0.150,0.112), 7),
                                 ub = c(rep(4,5), rep(1,5), rep(0.4,5), 14),
                                 opts = opts,
                                 C_water_0 = C_water_0,
                                 nm_types = nm_types,
                                 V_water = V_water,
