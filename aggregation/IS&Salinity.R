MR <- list("KH2PO4" = 136.086, "NaCl" = 58.44, "Na2HPO4" = 141.96, "Ca(NO3)2" = 164.1 ,
           ...
           "NaH2PO4" = 119.98,  "MgCl2" = 95.211, "Na3C6H5O7" = 258.06, "Na2CO3" = 105.99, "NaNO3" = 85,
           "Na2MgEDTA" = 358.50 ,"FeCl3" = 162.2,  "H3BO3" = 61.83, "MnCl2" = 125.84, "ZnSO4" = 161.47 ,
           "CuSO4" = 159.61, "Co(NO3)2" = 182.94, "NaMoO4" = 205.93, "Na2SiO3" = 122.06, "K2HPO4" = 174.2,
           "NH4Cl" = 53.491, "Na2EDTA" = 372.24)#g/mol
...
media <- list("PBS" = list("KH2PO4" = 144,  "NaCl" = 9000, "Na2HPO4" = 795),
              ...
              "SM7" = list("NaHCO3" = 64.8, "NaNO3" = 0.274,  "KCl" = 5.8, "CaCl2" = 293.8,"MgSO4" = 123.3,
                           "K2HPO4" = 0.184 , "KH2PO4" = 0.143,  "Na2SiO3" = 10  ),
              
              "ISO_8692" = list("NaHCO3" = 50, "NH4Cl" = 15, "MgCl2" = 12,
                                "CaCl2" = 18, "MgSO4" = 15, "K2HPO4" = 1.6,
                                "FeCl3" = 0.08, "Na2EDTA" = 0.1, "H3BO3" = 0.185,
                                "MnCl2" = 0.415)) #mg/L
